...
model = AutoModelForCausalLM.from_pretrained('./train_multimodal_from_scratch/save/sft')
model.to(device)
...
image = Image.open('./train_multimodal_from_scratch/test_images/th4.png').convert("RGB")
